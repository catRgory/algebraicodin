...
While Petri nets (see
[`vignette("composition")`](https://catrgory.github.io/algebraicodin/articles/composition.md))
are an excellent formalism for mass-action kinetics, many dynamical
systems don’t fit neatly into the Petri net framework — especially
when: - Rate laws are nonlinear or involve sums like total population
*N* - The system includes **delay differential equations** (DDEs) - You
want **directed** signal flow (inputs and outputs)
...
![](dynamics_files/figure-html/sir-plot-1.png)
...
![](dynamics_files/figure-html/lv-simulate-1.png)
...
![](dynamics_files/figure-html/discrete-rs-1.png)
...
![](dynamics_files/figure-html/machine-simulate-1.png)
...
![](dynamics_files/figure-html/machine-parallel-1.png)
...
|---------------------|----------------------------------------------------------------------------------------------------|---------------------------------------------|
| **Petri nets**      | [`oapply()`](https://catrgory.github.io/algebraicodin/reference/oapply.md) via UWD                 | Mass-action kinetics, stoichiometric models |
| **ResourceSharers** | [`oapply_dynam()`](https://catrgory.github.io/algebraicodin/reference/oapply_dynam.md) via UWD     | General ODEs with shared state              |
| **Machines**        | [`oapply_machine()`](https://catrgory.github.io/algebraicodin/reference/oapply_machine.md) via DWD | Directed signal flow, control systems       |
