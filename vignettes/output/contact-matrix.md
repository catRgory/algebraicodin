...
infection<sub>*i*</sub> = *β* ⋅ *S*<sub>*i*</sub> ⋅ *I*<sub>*i*</sub>/*N*<sub>*i*</sub>

With a contact matrix *C*, the **force of infection** on group *i* sums
infectious pressure from *all* groups:

*λ*<sub>*i*</sub> = ∑<sub>*j*</sub>*C*<sub>*i**j*</sub> ⋅ *I*<sub>*j*</sub>/*N*<sub>*j*</sub>
infection<sub>*i*</sub> = *λ*<sub>*i*</sub> ⋅ *S*<sub>*i*</sub>
...
![](/Users/sdwfrost/Projects/catRgory/algebraicodin/vignettes/output/contact-matrix_files/figure-markdown_strict/plot-comparison-1.png)
...
![](/Users/sdwfrost/Projects/catRgory/algebraicodin/vignettes/output/contact-matrix_files/figure-markdown_strict/contact-heatmap-1.png)
...
![](/Users/sdwfrost/Projects/catRgory/algebraicodin/vignettes/output/contact-matrix_files/figure-markdown_strict/three-sim-1.png)
...
![](/Users/sdwfrost/Projects/catRgory/algebraicodin/vignettes/output/contact-matrix_files/figure-markdown_strict/mix-aging-sim-1.png)

## Frequency vs. density dependence

The default mixing type is **frequency-dependent** (divided by
*N*<sub>*j*</sub>). For **density-dependent** transmission (no
normalization), use:
...
<tbody>
<tr>
<td>Frequency-dependent mixing</td>
<td><code>mixing = list(infection = "C")</code></td>
</tr>
<tr>
<td>Density-dependent mixing</td>
<td><code>mixing = list(infection = list(contact = "C", type = "density"))</code></td>
</tr>
<tr>
<td>Combined with aging</td>
<td>Add <code>cross_strata_flows</code> as usual</td>
</tr>
<tr>
<td>Contact parameter names</td>
<td><code>C_&lt;infectee&gt;_&lt;infector&gt;</code> (e.g.,
<code>C_young_old</code>)</td>
</tr>
</tbody>
</table>
